...
/* De keuringen staan in een apart bestand. In een template literal worden
   backslashes opgegeten, en dan wordt /\s+/ stilletjes /s+/ — wat elke
   letter s uit de tekst haalt en vals alarm geeft. */
const staart = fs.readFileSync(__dirname + "/keuring.js", "utf8");
